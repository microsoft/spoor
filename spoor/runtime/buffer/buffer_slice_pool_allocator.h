...
// 
//   [[nodiscard]] static constexpr auto allocate(Allocator& allocator, size_t size) -> T*;
//   static constexpr auto deallocate(Allocator& a, T* p, size_t n) -> void;
//   template<class... Args >
...
// 
// template <class T>
// constexpr auto allocator_traits<spoor::runtime::buffer::BufferSlicePoolAllocator<T>>::allocate(Allocator&, const size_t size) -> T*{
//   return static_cast<T*>(::operator new(size * sizeof(T)));
// }
// 
// template <class T>
// constexpr auto allocator_traits<spoor::runtime::buffer::BufferSlicePoolAllocator<T>>::deallocate(Allocator&, T* ptr, const size_t) -> void {
//   ::operator delete(ptr);
// }
// 
// }  // namespace std
