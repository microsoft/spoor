...
{
  flushTraceEventsWithCallback_ = [callback]() { if (callback != nil) callback(); };
                                   ...
                                   callback:(void (^)(const SpoorDeletedFilesInfo *) _Nullable)callback
{
  deleteFlushedTraceFilesOlderThanTimestampCallback_ = [callback](_spoor_runtime_DeletedFilesInfo deletedFilesInfo) {
    if (callback != nil) callback([[SpoorDeletedFilesInfo alloc] initWithDeletedFilesInfo:deletedFilesInfo]);
  };
