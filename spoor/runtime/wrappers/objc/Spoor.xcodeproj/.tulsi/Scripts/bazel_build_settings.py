...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_thmeisel/1397f6cdb71f62812c40080b8680630c/execroot/spoor',
    'ios_x86_64',
    {
        'macos_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/thmeisel/Library/Application Support/Tulsi/0.20210318.88/Bazel',
