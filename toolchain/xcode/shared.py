...
SPOOR_INSTRUMENTATION_OUTPUT_FUNCTION_MAP_FILE_KEY = \
...
def _make_spoor_opt_env(env, output_file):
  ...
  if SPOOR_INSTRUMENTATION_OUTPUT_FUNCTION_MAP_FILE_KEY not in env:
    path = pathlib.Path(output_file)
    env[SPOOR_INSTRUMENTATION_OUTPUT_FUNCTION_MAP_FILE_KEY] = str(
        path.with_suffix('.spoor_function_map'))
  return env
